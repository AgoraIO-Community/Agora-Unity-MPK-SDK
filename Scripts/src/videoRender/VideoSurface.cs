...
namespace agora.media_player
{
    ...
    public sealed class VideoSurface : MonoBehaviour
    {
        ...
        [SerializeField] private int VideoPixelWidth = 1980;
        ...
        private IrisMpkVideoFrame _cachedVideoFrame = new IrisMpkVideoFrame();
        ...
        private IAgoraMediaPlayer GetMediaPlayer()
        {
            var player = AgoraMediaPlayer.Get();
            if (_needUpdateInfo && player != null)
            {
                if (_videoStreamManager == null)
                {
                    _videoStreamManager = ((AgoraMediaPlayer) player).GetVideoStreamManager();
                }
                ...
                _needResize = true;
                FreeMemory();
                _cachedVideoFrame = new IrisMpkVideoFrame
                {
        ...
        public void SetForUser(uint uid = 0, string channelId = "", int videoPixelWidth = 1980,
        ...
        void OnDestroy()
        {
            ...
            if (GetMediaPlayer() != null && _videoStreamManager != null)
            {
